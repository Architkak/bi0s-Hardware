...
class task_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Challenge_3")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Challenge_3")
        ...
        # Blocks
        ##################################################
        self._volume_range = Range(0, 1, 0.05, 0.300, 200)
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_fcf(16, firdes.low_pass(1, samp_rate, samp_rate/(2*decim), 2000), 0, samp_rate)
        ...
        self.analog_agc_xx_1 = analog.agc_cc(0.000625, 1.0, 1.0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_agc_xx_1, 0), (self.blocks_complex_to_mag_0, 0))
